            ...
            for product in products:
                ...
                if not store_prices:
                    ...
                    if base_prices:
                        ...
                        # CRITICAL: store_base_prices table not found - this should not happen
                        logger.error(f"store_base_prices table not available for product {product.productId}")
                        
                        # Emergency fallback: show error message to admin
                        ...
                        for store in all_stores:
                            store_prices.append(type('StorePrice', (), {
                                ...
                                'offerDetails': 'ERROR: Missing store_base_prices table'
                            })())
