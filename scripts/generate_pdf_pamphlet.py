...
local_filename = '../data/temp_master_list.csv'
...
output_csv_filename = f'../data/no.{current_week}week_special.csv'
pdf_filename = f'../data/no.{current_week}week_special.pdf'
